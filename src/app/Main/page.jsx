  ...
  return (
    <div className='relative'>
      <Image
        ...
        priority
      />
      <div className='absolute inset-0 font-mediun text-white ' style={{fontSize:'35px', marginLeft:'12rem', marginTop:'22rem', fontFamily:'Barlow'}}>
